...
from minerconfig.bluetooth.descriptors.add_gateway_descriptor import AddGatewayDescriptor
from minerconfig.bluetooth.descriptors.opaque_structure_descriptor import OpaqueStructureDescriptor
import lib.protos.add_gateway_pb2 as add_gateway_pb2

class AddGatewayCharacteristic(Characteristic):

    def __init__(self, service):
        Characteristic.__init__(
                self, minerconfig.constants.ADD_GATEWAY_CHARACTERISTIC_UUID,
    ...
    def AddGatewayCallback(self):
        if self.notifying:
            ...
            self.PropertiesChanged(minerconfig.constants.GATT_CHRC_IFACE,
    ...
    def StartNotify(self):
        ...
        self.PropertiesChanged(minerconfig.constants.GATT_CHRC_IFACE, {"Value": self.notifyValue},
                               [])
